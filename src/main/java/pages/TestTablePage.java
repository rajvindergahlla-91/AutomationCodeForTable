...
public class TestTablePage {
	...
	// private By anyOption =
	// By.xpath("//div[@class='dropdown-button']//following-sibling::ul//li[3]");
	...
	public boolean verifyTableData(String id, String courseName, String language, String level, String enrollments, String link)
			{
		...
		for (WebElement row : rows) {
			...
			String actualCourse = row.findElement(By.xpath("./td[2]")).getText();

			String actualLanguage = row.findElement(By.xpath("./td[3]")).getText();

			String actualLevel = row.findElement(By.xpath("./td[4]")).getText();

			String actualEnrollments = row.findElement(By.xpath("./td[5]")).getText();

			String actualLink = row.findElement(By.xpath("./td[6]")).getText();

			if (actualId.equals(id) && actualCourse.equals(courseName) && actualLanguage.equals(language)
					&& actualLevel.equals(level) && actualEnrollments.equals(enrollments) && actualLink.equals(link)) {
